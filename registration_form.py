...
if __name__ == "__main__":
    ...
    facultate.grid(row=2, column=0)
    serie.grid(row=3, column=0)
    grupa.grid(row=4, column=0)
    email.grid(row=5, column=0)
    adresa.grid(row=6, column=0)
    telefon.grid(row=7, column=0)
    nastere.grid(row=8, column=0)
